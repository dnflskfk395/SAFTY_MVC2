...
import com.exam.service.SF_join3Req_service;
import com.exam.service.SF_join3Service_service;

public class SF_join3_handler implements Action{
	
	private static final String VIEW = "/safety/SignUp/join3_3.jsp";
	private SF_join3Service_service joinService = new SF_join3Service_service();
	...
	private String processSubmit(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		SF_join3Req_service joinReq = new SF_join3Req_service();
		...
		joinReq.setNumber(req.getParameter("groupNumber"));
