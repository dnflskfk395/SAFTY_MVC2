<%@ page language="java" contentType="text/html; charset=EUC-KR"
    pageEncoding="EUC-KR"%>
<!DOCTYPE html>
<link rel="stylesheet" href="/safty_mvc2/safety/css/sf_campaign.css">
...
<div class="sf_campaign_inner">
	...
	<div  class="sf_campaign_btn_div">
		<div class="sf_campaign_btn1">
			...
			<img src="/safty_mvc2/safety/image/화살표_22PX.png" alt="" id="sf_campaign_icon"/>
		</div>
	...
	<div class="sf_campaign_title_div">
		...
		<div class="sf_campaign_title_txt2">
			...
			<img src="/safty_mvc2/safety/image/자세히보기btn.png" alt="" class="sf_campaign_plus_icon2"/>
		...
		<div class="sf_campaign_title_txt3">
			...
			<img src="/safty_mvc2/safety/image/자세히보기btn.png" alt="" class="sf_campaign_plus_icon3"/>
