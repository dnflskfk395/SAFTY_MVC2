...
<div style="width: 1920px; height: 1050px;">
	...
	<tr id="tr1">
			<td id="pageList">
				...
				<a href="/safty_mvc2/safety/test4.jsp?cp=<%=i %>"><span id="page"></span></a>
				<%
					}// if end
	...
	<div>
	<a href="/safty_mvc2/safety/test4.jsp?cp=<%=currentPage+1 %>"><div style=" margin:-330px -40px 0 0; width: 70px; height: 70px;float: right;">
		<img src="/safty_mvc2/safety/image/right.png" alt="" style="width: 100%; height: 100%;" />
	</div></a>
	<a href="/safty_mvc2/safety/test4.jsp?cp=<%=currentPage-1 %>"><div style=" margin:-330px 0 0 -40px; width: 70px; height: 70px;float: left;">
		<img src="/safty_mvc2/safety/image/left.png" alt="" style="width: 100%; height: 100%;" />
	</div></a>
	</div>
	</div>
	</div>
