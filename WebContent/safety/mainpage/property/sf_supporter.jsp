...
<link rel="stylesheet" href="/safty_mvc2/safety/css/sf_supporter.css">

<script type="text/javascript">

$(function() {
 $('#sponedbtn1').click(function () {
	 location.href = "/safty_mvc2/safety/support/NewFile.jsp"; /* 해당링크로 */
 });
 $('#sponedbtn2').click(function () {
	 location.href = "/safty_mvc2/safety/support/organization_mod.jsp";/* 해당링크로 */
 });
