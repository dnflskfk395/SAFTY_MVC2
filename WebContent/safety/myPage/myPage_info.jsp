					...
					<jsp:include page="/safety/ServiceCenter/backBoard_right.jsp"></jsp:include>
						...
						<form action="myPage2.do" method="post">
							...
							<table class="inquiry_Table">
								...
								<tr>
									<th><span>성명</span></th>
									<td><input type="text" name="name" class="modifyInfo"
								...
								<tr class="onetr">
									...
									<td><input type="password" name="password"
										class="modifyInfo" style="font-family: 'Godic';" /></td>

								</tr>
								<tr class="onetr">
									<th><span>휴대폰 번호</span></th>
									<td><input type="text" name="tel" class="modifyInfo"
										value="${authUser.tel}" /></td>
								...
								<tr>
									...
									<td><input type="text" name="email" id=""
										class="modifyInfo" value="${authUser.email }" readOnly /></td>
								</tr>
							</table>
					
							<div class="table_button">

								<input type="submit" value="회원정보수정" class="table_Bt" />
							</div>
						</form>
					</div>
				</div>
