...
<script type="text/javascript">
	...
	function confirmId() {
		...
		url = ("/safty_mvc2/safety/SignUp/idCheck3.jsp?id=" + document.getElementById("userId").value);
		open(
				url,
				"confirm",
...
<body>
	...
	<div class="box-container">
		...
		<form method="post" action="join3.do"
			...
			<table class="table input_table">
				...
				<tr>
					...
					<td><input name="groupName" type="text" class="basic"
						id="groupName" value="${param.groupName}">
					<br />
					<div class="elCheck">	
					<c:if test="${errors.man }">법인체명을 입력해주세요</c:if>
					</div>
					</td>
				</tr>
				<tr>
					<th><span>담당자 명</span></th>
					<td><input name="name" type="text" class="basic" id="groupMan" value="${param.name}">
					<br />
					<div class="elCheck">	
					<c:if test="${errors.name }">담당자 이름을 입력해주세요</c:if>
					</div>
					</td>
				</tr>
				<tr>
					...
					<td><div class="btnAll">
					<input name="groupNumber" type="text" id="userNum"
						class="groupNum" placeholder="13자리로 입력해주세요 ('-'제외)"
						onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"
						maxlength="13" value="${param.groupNumber}"> <input type="button"
						id="btnCheck" value="번호 찾기" onclick="openWin()" class="groupBtn" 
						 />
						 <br />
						<div class="elCheck">	
						<c:if test="${errors.number }">법인체 번호를 입력해주세요</c:if>
					</div>
					</div>
						 </td>
				</tr>
				...
				<tr>
					...
					<input name="userId" id="userId" type="text"
						...
						value="idUncheck" style="width: 120px" /><br />
						<div id="idCheck" style="color: red"></div>
						<div class="elCheck">	
						<c:if test="${errprs.id }">아이디를 입력해주세요</c:if>
				...
				<tr>
					...
					<td><input type="password"
						...
						id="password1" maxlength="16" class="basic" value="${param.password1}">
						<br />
						<div class="elCheck">	
				...
				<tr>
					<th><span>이메일</span></th>
					<td> <div class="select">
						<input name="email1" type="text" class="emailBox1"
