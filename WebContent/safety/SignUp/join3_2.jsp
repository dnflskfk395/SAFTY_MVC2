...
<script type="text/javascript">
	...
	function confirmId() {
		...
		url = ("/safty_mvc2/safety/SignUp/idCheck2.jsp?id=" + document.getElementById("userId").value);
		open(
				url,
				"confirm",
	...
	var email = document.getElementById("email1").value;
		...
		url = ("/safty_mvc2/safety/SignUp/mailsend.jsp?mail=" + document.getElementById("email1").value+"@"+document.getElementById("email_select").value);
		open(
				url,
				"confirm",
...
<div id="top">
	...
	<form method="post" action="join2.do" onsubmit="return check()" accept-charset="utf-8"
			class="form-box" >
			...
			<table class="table input_table">
				...
				<tr>
					...
					<td><input name="groupName" type="text" class="basic"
						id="groupName" value="${param.groupName}"> <br />
						<div class="elCheck">
						<c:if test="${errors.man }">단체명을 입력해주세요</c:if>
					</div>
						</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<br />
						<div class="elCheck">
					<c:if test="${errors.linumber }">담당자 이름을 입력해주세요</c:if>
					</div>
					</td>
				</tr>
				...
				<tr>
					...
					<td><input type="password" title="비밀번호를 한번 더 입력해주세요."
						...
						maxlength="16" class="basic" value="${param.password2}"><br />
							<div class="elCheck">
				...
				<tr>
					...
					<td>
						...
						<div class="elCheck">
						<c:if test="${ errors.pcode }">주소를 선택하세요</c:if>
					</div>
					</td>
