 ...
 */
		url = ("/safty_mvc2/safety/SignUp/idCheck1.jsp?id=" + document.getElementById("userId").value);
		open(
				url,
				"confirm",
	...
	function emailCheck() {
		...
		url = ("/safty_mvc2/safety/SignUp/mailsend.jsp?mail=" + document.getElementById("email1").value
...
<body>
	...
	<div class="box-container">
		...
		<form  action="join.do" onsubmit="return login()"
			method="post" accept-charset="utf-8" class="form-box">
			...
			<table class="table input_table">
				...
				<tr>
					...
					<td><input name="userId" id="userId" type="text"
						placeholder="아이디는 영문, 숫자를 혼합하여  6~16자로 사용해 주세요" class="groupNum" value="${param.userId}"/>
						<input type="button" id="btnCheck" value="중복 체크"
						onclick="confirmId()" name="confirm_id" class="groupBtn" /><br />
				...
				<tr>
					...
					<td><input type="password"
						...
						id="password1" maxlength="16" class="basic" value="${param.password1}"><br />
						<div class="elCheck">
						<c:if test="${errors.pw }">패스워드를 입력하세요</c:if>
						</div>
						</td>
				</tr>
				<tr>
					...
					<td><input type="password" title="비밀번호를 한번 더 입력해주세요."
						...
						maxlength="16" class="basic" value="${param.password2}">
						 <br />
						<div class="elCheck">
						<c:if test="${ errors.cfPw }">패스워드를 한번 더 입력하세요</c:if>
						<c:if test="${ errors.notEquals }">패스워드가 일치하지 않습니다.</c:if>
						</div> 
				...
				<tr>
					<th><span>이름</span></th>
					<td><input name="name" type="text" class="basic" id="realName" value="${param.name}"> <br />
					<div class="elCheck">
				...
				<tr>
					...
					<td><input type="radio" name="radios" id="radio1" value="1" />
						<label for="radio1" class="genderC"><span class="gender"
							style="width: 40px">남자</span></label> &nbsp;&nbsp; 
						<input type="radio"name="radios" id="radio2" value="2" /> 
						<label for="radio2"class="genderC"><span class="gender">여자</span></label><br /><br />
						<div class="elCheck">
						<c:if test="${errors.gender }">성별을 선택해주세요</c:if>
						</div>
						</td>
				</tr>
				<tr>
					...
					<td><input type="text" name="birth1" class="basic" id="birth"
						...
						onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" value="${param.birth1}"/> <br />
						<div class="elCheck">
						<c:if test="${errors.bdate }">생년월일을 입력해주세요</c:if>
						</div>
						</td>
				</tr>
				<tr>
					...
					</select> <input type="button" id="submit" value="이메일 인증" onclick="emailCheck()" name="passWordOk" />
						<br />
						<div class="elCheck">
				...
				<tr>
					...
					<td><select name="hp1" class="hpAll">
						...
						<div class="elCheck">            
						<c:if test="${errors.phone }">휴대폰 번호를 작성해주세요</c:if>
						</div>
						</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<div class="elCheck">
						<c:if test="${errors.pcode }">주소를 입력해주세요</c:if>
						</div>
					</td>
		...
		<div class="help-join">
			<img src="/safety/image/bottom.png" id="bottomImg" alt="">
		</div>
		<!-- form-box end -->
	</div>
